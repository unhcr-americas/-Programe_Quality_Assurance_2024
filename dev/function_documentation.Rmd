...
```{r function-report_result_resource}
# usethis::use_rmarkdown_template(
#   template_name = "report_result_resource",
#   template_dir = NULL,
#   template_description = "Report Resource & Results",
#   template_create_dir = TRUE
# )
#' Generate a summary word report
#' 
...
#' @export 
#'
report_result_resource <- function(year = 2023, 
                      activityInfoTable,
                      folder = "Report") {
  ...
  rmarkdown::render(
    system.file("rmarkdown/templates/report_result_resource/skeleton/skeleton.Rmd", 
                package = "ProgQA"),
    output_file = here::here(folder, paste0('report_result_resource-', 
...
```{r tests-report_result_resource}
